...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    from cs336_systems.trition_kernel.pytorch_flash_attention_2 import PytorchFlashAttention2
    return PytorchFlashAttention2
...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    from cs336_systems.trition_kernel.triton_flash_attention_2 import TritonFlashAttention2
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    from cs336_systems.parallelism.ddp.ddp_overlap_bucketed_class import DDP
    return DDP(module=module, bucket_size_mb=bucket_size_mb)
...
def get_sharded_optimizer(params, optimizer_cls: Type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    ...
    """
    from cs336_systems.parallelism.ddp.ddp_optimizer_state_sharding_class import DDPOptimizer
